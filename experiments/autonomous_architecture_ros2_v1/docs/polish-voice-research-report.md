...
| **Language policy** | English everywhere; Polish only in the spoken sentence | — | free | see [agent-layer.md](agent-layer.md) |
...
likely fix this; see [agent-layer.md](agent-layer.md) for the brain-size options.
