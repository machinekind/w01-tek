# Polish voice for Wojtek: what we picked, and everything we rejected

Research round of 2026-08-07, verified against model cards, technical reports
and the papers themselves rather than blog posts. This is the decision record
for the realtime Polish voice stack; the implementation is described in
[agent.md](agent.md).
