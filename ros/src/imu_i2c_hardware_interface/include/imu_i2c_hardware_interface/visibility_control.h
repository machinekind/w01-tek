...
// (template, see bmx160_serial_hardware_interface)
//
...
#ifndef IMU_I2C_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define IMU_I2C_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // IMU_I2C_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
