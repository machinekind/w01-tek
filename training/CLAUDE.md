...
| `imu_grid.sh` | Eval-only IMU robustness grid over existing runs: pinned gyro-bias sweep (plus optional white gyro-noise levels), scored on standing/walking vibration, the 20-25 Hz limit-cycle band, falls, and walk tracking. |
